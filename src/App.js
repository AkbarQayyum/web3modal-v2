...
// import SelectWalletModal from "./Components/Models/Model";
// import { useWeb3React } from "@web3-react/core";
// import { CheckCircleIcon, WarningIcon } from "@chakra-ui/icons";
// import { Tooltip } from "@chakra-ui/react";
// import { networkParams } from "./network/networks";
...
import { web3Modal } from "./connectors/web3Modal";
...
export default function App() {
  ...
  return (
    <div className="parent">
      ...
      <button onClick={DisconnectNetwork}>Disconnect</button>

      <div>
        {state !== null ? (
          <>
            <h2>Balance : {ethers.utils.formatEther(state.balance)}</h2>
